...
export const THEME_CONFIGS: Record<Theme, ThemeConfig> = {
  ...
  retro: {
    id: "retro",
    name: "Retro Commando: Alien Jackpot",
    description: "90s arcade-inspired jungle alien battle slot with pixel art and CRT effects",
    price: 25000,
    unlocks: [
      "✓ Retro arcade cabinet frame",
      "✓ Pixel commando symbols",
      "✓ Laser blue paylines with arcade glow",
      "✓ Pixel explosion win effects",
      "✓ Boss Battle free spins mode",
      "✓ CRT scanline overlay",
      "✓ Arcade sound effects",
    ],
    
    background: "#07110A",
    cabinetFrame: "border-red-600",
    cabinetBorder: "border-red-700",
    
    symbolSet: ["🎖️", "🔫", "🔫", "💣", "📦", "⚡", "🌀"],
    wildName: "POWER-UP WILD",
    wildIcon: "⚡",
    scatterName: "ALIEN PORTAL",
    scatterIcon: "🌀",
    
    jackpotName: "ALIEN JACKPOT",
    bonusName: "BOSS BATTLE",
    bonusText: "Collect 3 Alien Portals to unlock Boss Battle Free Spins!",
