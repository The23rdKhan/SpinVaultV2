...
/** RN-friendly colors (replaces Tailwind class strings from web). */
export const RARITY_COLORS: Record<
  VanityRarity,
  { bg: string; text: string; border: string; glow: string }
> = {
  common: { bg: 'rgba(113,113,122,0.2)', text: '#a1a1aa', border: '#71717a', glow: '' },
  rare: { bg: 'rgba(59,130,246,0.2)', text: '#60a5fa', border: '#3b82f6', glow: '#3b82f64d' },
  epic: { bg: 'rgba(168,85,247,0.2)', text: '#c084fc', border: '#a855f7', glow: '#a855f766' },
  legendary: { bg: 'rgba(245,158,11,0.2)', text: '#fbbf24', border: '#f59e0b', glow: '#f59e0b80' },
  mythic: { bg: 'rgba(244,63,94,0.2)', text: '#fb7185', border: '#f43f5e', glow: '#f43f5e99' },
}
