...
import { SUPPORT_URLS } from "@shared/support-urls"
  ...
  return (
    <div className="flex flex-col gap-6 p-4 pb-24 overflow-y-auto">
      ...
      <section>
        ...
        <div className="bg-card rounded-xl border border-border divide-y divide-border">
          <SupportLink icon={HelpCircle} label="Help Center" href={SUPPORT_URLS.helpCenter} />
          <SupportLink icon={MessageCircle} label="Contact Support" href={SUPPORT_URLS.contactMail} />
        </div>
      </section>
    </div>
  )
